...
Because we are using a custom version of python3, we need to make sure our scripts know to use it.  To do that, put this as the first line in your script:

  #!/usr/bin/env python3

What that does is tell the shell that when it sees this script, use the python3 that is in the environment path (which you set above).
