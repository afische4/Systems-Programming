...
Your program should display each host:port followed by the SSH string, the message <connection refused>, or the message <connection timeout>.  For the given hosts.txt, the expected output is:
    ...
    newt.cse.nd.edu:22            SSH-2.0-OpenSSH_7.6p1 Ubuntu-4ubuntu0.3
    student00.cse.nd.edu:22       SSH-2.0-OpenSSH_7.4
    student00.cse.nd.edu:90       <connection refused>
    mcmillco.com:22               SSH-2.0-OpenSSH_8.2p1 Ubuntu-4ubuntu0.1
...
As a courtesy to me, please call your script scanner.py and place it in a directory called d12 in your dropbox.  Please do not put it in, e.g., python/d12 or name it scanner-LASTNAME.py and so on.
