...
THIS ASSIGNMENT IS DUE MONDAY NOVEMBER 2, not Friday October 30 as it normally would.  There will be no daily given Friday.  I will give out D27 on Monday.
...
Check) Full five points of credit.  You use pthreads correctly and store and output some reasonable results.  Have some way to adjust the number of threads like via setting NUM_THREADS to whatever value.
