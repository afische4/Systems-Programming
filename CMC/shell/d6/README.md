...
I also provided a test script for you as d6test.sh.  This time, since there is no regex to content with, the output should be unamibiguous.  Hopefully it will look like this when you run it!
