...
DUE: Friday August 14 by class start
VALUE: 2 points
...
DIRECTORY PERMISSION OCTAL CODE: ???
...
~/esc-courses/fa20-cse-20289.01/public/shell/d2/d2test.sh

Run it like this:

$ bash ~/esc-courses/fa20-cse-20289.01/public/shell/d2/d2test.sh NETID HIDDENDIR DIRPERM FILEPERM
...
$ cd ~/esc-courses/fa20-cse-20289.01/public/shell/d2/
