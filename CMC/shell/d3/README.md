...
DUE: August 17 at class start
POINTS: 4

## Setup

0) Obtain a copy of shakespeare.txt, which contains the complete works of William Shakespeare.  A read-only copy is located here: /escnfs/courses/fa20-cse-20289.01/public/shell/d3/shakespeare.txt
...
Make a directory called d3 in your dropbox.
