...
In this assignment, I am making you start on m2b, so you won't all come whining later that there is too much work to do because you waited until 10pm Sunday October 4 to start the milestone assignments.
...
Thank you everyone (except for John Hoeksema, who insists on his own subdirectory format, you just gotta be you John!) for putting your code in a folder called d14 directly in your dropbox and not under a subdirectory such as python/d14.  Also thank you for calling your script uniq.py and not uniq-lastname.py or something else.
