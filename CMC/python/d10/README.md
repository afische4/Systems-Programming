...
I have provided a test script like usual, *but also* as Python program that uses your dinodata module.  You need to edit this program so that it reads in any number of -y and -r flags using argparse.  See predatorprey-TEMPLATE.py *be sure to rename this file to predatorprey.py in your dropbox.*
...
(*not* dropbox/python/d10 or anything else, please)
